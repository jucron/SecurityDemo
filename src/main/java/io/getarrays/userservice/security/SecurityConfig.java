...
//todo 5: Create Security Config and override configure(AuthManagerBuilder) and configure(HttpSecurity)
@Configuration
@EnableWebSecurity
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    //todo 7: Create paths authorizations according to Roles (order in this matters)
    @Override
...
//        http.authorizeRequests().anyRequest().permitAll(); //no reason to permit all, it would not be secure.
